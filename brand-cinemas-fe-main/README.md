...
API docs for location filter (cities / cinemas / dates):

- [`docs/API_CITIES_CINEMAS.md`](docs/API_CITIES_CINEMAS.md)

API docs for homepage carousel (admin CRUD + public active list):

- [`docs/API_CAROUSEL.md`](docs/API_CAROUSEL.md)

API docs for admin user management:
